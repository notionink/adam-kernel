/*
 * QF9700_android one chip USB 2.0 ethernet devices
 *
...
static const struct ethtool_ops qf9700_android_ethtool_ops = {
...
static const struct net_device_ops qf9700_android_netdev_ops = {
	...
	.ndo_set_multicast_list = qf9700_android_set_multicast,
};
...
static int qf9700_android_bind(struct usbnet *dev, struct usb_interface *intf)
{
	...
	dev->net->netdev_ops = &qf9700_android_netdev_ops;
	...
	mdelay(2);		// at least 10us, here 2ms for safe, reset mac
	...
	mdelay(20);		// at least 1ms, here 20ms for safe reading right register
...
MODULE_DESCRIPTION("QF9700 one chip USB 2.0 ethernet devices on android platform");
MODULE_LICENSE("GPL");
